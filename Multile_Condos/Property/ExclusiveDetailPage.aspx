<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MultipleCondos.Master" CodeBehind="ExclusiveDetailPage.aspx.cs" Inherits="Property.ExclusiveDetailPage" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
                ...
                <div class="service_sect_bg">
                    ...
                    <div class="col-md-6 col-sm-6">
                        ...
                        <div class="property_inner_cntnt">
                            ...
                            <p id="descriptiontxt" class="desc_class" runat="server"></p>
                        </div>
    ...
    <script type="text/javascript">
        ...
        function binddropdown() {
            $.ajax({
                type: "POST",
                url: "/registrationfile.asmx/GetReSaleData",
