...
namespace Property_cls
{
    public class cls_Property
    {
        ...
        public DataTable GetLogobyId(int DreamHouseId)
        {
            DataTable dt = new DataTable();
            try
            {
                ...
                {
                    str = "select top(1) * from tbl_Condo_Logos";
                }
                else
                {
                    str = "select * from tbl_Condo_Logos where Id=" + DreamHouseId;
                }
        ...
        public int InsertDreamHouse(string Title, string filename, string Description,string Address,string Price,string logo)
        {
            int result = 0;
            try
            {
                ...
                cmd.Parameters.AddWithValue("@LogoImg", logo);
                cmd.Parameters.Add("@newID", SqlDbType.Int).Direction = ParameterDirection.Output;
